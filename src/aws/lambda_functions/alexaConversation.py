...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the smart curated clothing selector!"
...
def get_human_help_request():
    session_attributes = {}
    card_title = "Get Help"
    speech_output = "Understood! Don't worry, our shop assitant Nikil is on his way to help you!"
...
def on_intent(intent_request, session):
    ...
    elif intent_name == "callforHelpIntent":
        return get_human_help_request()
    else:
